...
public class ExtremeSpeedometer extends View {
    ...
    private final String[] categories = {
            "Underweight", "Normal", "Overweight", "Obese I", "Obese II", "Obese III", "Extreme"
    };

    private final float[] bmiThresholds = {4f, 18.5f, 25f, 30f, 35f, 40f, 60f,100f};
    ...
    public ExtremeSpeedometer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void setBmiValue(double value) {
        this.bmi = Math.max(1, Math.min(100, value));
        invalidate();
    }
...
// Draw circular base at center
    ...
    private String getBmiCategory(double bmi) {
        ...
        else if (bmi < 50) return "Obese III";
        else return "Extreme";
    }
    private int getCategoryColor(double bmi) {
        ...
        else if (bmi < 60) return Color.parseColor("#C62828");   // Obese III - Dark Red
